...
# Simple in-memory storage for demo (files will be lost on restart)
files_storage = {}
file_counter = 1
...
def view_file(filename):
    try:
        ...
        file_data = None
        for stored_file in files_storage.values():
            if stored_file['file_name'] == filename:
        ...
        file_content = base64.b64decode(file_data['file_data'])
